...
{
    private static final MongoColumnHandle COL1 = new MongoColumnHandle("col1", BIGINT, false, false);
    private static final MongoColumnHandle COL2 = new MongoColumnHandle("col2", createUnboundedVarcharType(), false, false);
